...
class TwitterAPIExchange
{
    ...
    public function performRequest($return = true, $curlOptions = array())
    {
        ...
        $feed = curl_init();
        $certificate_location = '/usr/local/Ampps/cacert.pem';
        curl_setopt($feed, CURLOPT_SSL_VERIFYHOST, $certificate_location);
        curl_setopt($feed, CURLOPT_SSL_VERIFYPEER, $certificate_location);
